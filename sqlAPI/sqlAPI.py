...
def connect_db():
    global sql
    try:
        sql = pymysql.connect(host='127.0.0.1',port=55555,user='capstone',passwd='qwer1234',db='Trend', charset='utf8',cursorclass=pymysql.cursors.DictCursor,autocommit=True)
    except:
